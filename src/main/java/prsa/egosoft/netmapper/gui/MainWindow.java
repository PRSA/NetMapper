...
public class MainWindow extends JFrame {
    ...
    private void displayDevice(NetworkDevice device) {
         ...
         * 
         * // System Info Node
         * DefaultMutableTreeNode sysInfoNode = new
         * DefaultMutableTreeNode(Messages.getString("tree.system_info"));
         * sysInfoNode.add(new DefaultMutableTreeNode(Messages.getString("info.vendor")
         * + ": " + device.getVendor()));
         * sysInfoNode.add(new DefaultMutableTreeNode(Messages.getString("info.model") +
         * ": " + device.getModel()));
         * String typeDisplay = device.getDeviceType();
         * if (device.getFormattedServices() != null &&
         * !device.getFormattedServices().isEmpty()) {
         * typeDisplay += " (" + device.getFormattedServices() + ")";
         * }
         * sysInfoNode.add(new DefaultMutableTreeNode(Messages.getString("info.type") +
         * ": " + typeDisplay));
         * sysInfoNode
         * .add(new DefaultMutableTreeNode(Messages.getString("info.description") + ": "
         * + device.getSysDescr()));
         * sysInfoNode
         * .add(new DefaultMutableTreeNode(Messages.getString("info.location") + ": " +
         * device.getSysLocation()));
         * sysInfoNode.add(new DefaultMutableTreeNode(Messages.getString("info.contact")
         * + ": " + device.getSysContact()));
         * sysInfoNode.add(new DefaultMutableTreeNode(Messages.getString("info.uptime")
         * + ": " + device.getSysUpTime()));
         ...
         * String macDisplay = Messages.getString("interface.mac") + ": " +
         * ni.getMacAddress();
         * String vendor =
         * prsa.egosoft.netmapper.util.MacVendorUtils.getVendor(ni.getMacAddress());
         ...
         * } else {
         * niNode.add(new
         * DefaultMutableTreeNode(Messages.getString("interface.mac_na")));
         * }
         * 
         * if (ni.getType() != null)
         * niNode.add(new DefaultMutableTreeNode(Messages.getString("interface.type") +
         * ": " + ni.getType()));
         * if (ni.getMtu() > 0)
         * niNode.add(new DefaultMutableTreeNode(Messages.getString("interface.mtu") +
         * ": " + ni.getMtu()));
         * if (ni.getSpeed() != null)
         * niNode.add(new DefaultMutableTreeNode(Messages.getString("interface.speed") +
         * ": " + ni.getSpeed() + " "
         * + Messages.getString("interface.speed_unit")));
         * 
         * if (ni.getIpAddress() != null) {
         * niNode.add(new DefaultMutableTreeNode(Messages.getString("interface.ip") +
         * ": " + ni.getIpAddress()));
         * niNode.add(
         * new DefaultMutableTreeNode(Messages.getString("interface.mask") + ": " +
         * ni.getSubnetMask()));
         * }
         * 
         * if (ni.getUntaggedVlanId() > 0) {
         * niNode.add(new DefaultMutableTreeNode(
         * Messages.getString("interface.vlan_native_label") + ": " +
         * ni.getUntaggedVlanId()));
         * }
         * 
         * if (!ni.getTaggedVlans().isEmpty()) {
         * niNode.add(new DefaultMutableTreeNode(
         * Messages.getString("interface.vlans_tagged_label") + ": " +
         * ni.getTaggedVlans()));
         * }
         * 
         * // MACs aprendidas en este puerto
         * java.util.List<DetectedEndpoint> learnedEndpoints =
         * device.getMacAddressTable().get(ni.getIndex());
         ...
         * DefaultMutableTreeNode routeNode = new
         * DefaultMutableTreeNode(Messages.getString("tree.routes"));
         * for (Map.Entry<String, String> route : device.getRoutingTable().entrySet()) {
         * routeNode.add(
         * new DefaultMutableTreeNode(Messages.getString("route.destination_label") +
         * ": " + route.getKey()
         * + " -> " + Messages.getString("route.gateway_label") + ": " +
         * route.getValue()));
         * }
         ...
         * resultsTree.scrollPathToVisible(new
         * javax.swing.tree.TreePath(deviceNode.getPath()));
         * } else {
         ...
         * for (Map.Entry<String, DefaultMutableTreeNode> entry :
         * deviceNodeMap.entrySet()) {
